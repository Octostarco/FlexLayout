...
class Layout extends React.Component {
    ...
    handleWorkerMessage(e) {
        ...
        if (e.data.clientX > windowLeftBound && e.data.clientX < windowRightBound) {
            // drop happened
            if (DragDrop_1.DragDrop.instance.isDragging() && e.data.type === "drop") {
            ...
            else if (!DragDrop_1.DragDrop.instance.isDragging() && e) {
                DragDrop_1.DragDrop.instance.startX = 0;
        ...
        else if (DragDrop_1.DragDrop.instance.isDragging() && e.data.type === "drop") {
            DragDrop_1.DragDrop.instance._onMouseUp(e);
            DragDrop_1.DragDrop.instance.startX = 0;
            this.externalDragStarted = false;
        }
     ...
     * @returns { MouseEvent }
     */
    deserializeMouseEvent(serializedEvent, clientX, clientY, originScreenX, originScreenY) {
        const { type, eventData, serializedEventTarget } = serializedEvent;
        let finalX = 0;
        let finalY = clientY;
        ...
        function calculateMouseEventHeight() {
            if (window.screenY < originScreenY) {
                if (!DragDrop_1.DragDrop.instance.startY) {
                    DragDrop_1.DragDrop.instance.startY = clientY;
                }
        ...
        function calculateMouseEventWidth() {
            if (window.screenX > originScreenX) {
                if (!DragDrop_1.DragDrop.instance.startX) {
                    DragDrop_1.DragDrop.instance.startX = clientX;
                }
        ...
        const target = new DOMParser().parseFromString(serializedEventTarget, "text/html");
        const event = new MouseEvent(type, Object.assign(Object.assign({}, eventData), { clientX: finalX, clientY: finalY }));
