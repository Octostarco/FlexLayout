...
const TabButtonStamp = (props) => {
    ...
    let content = renderState.content ? React.createElement("div", { className: cm(Types_1.CLASSES.FLEXLAYOUT__TAB_BUTTON_CONTENT) }, renderState.content) : node._getNameForOverflowMenu();
